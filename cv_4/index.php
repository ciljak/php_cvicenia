...
if(filter_has_var(INPUT_POST, 'submit')){
      ...
      foreach($room_temperature as $index => $temperature) {
            ...
            //echo $temperature;
            $sum_of_temperatures = $sum_of_temperatures + $temperature; // x += temp; x = x + temp;
      }
      ...
      $index = 1;
      $number_of_elements_in_array = sizeof($room_temperature); //
...
<html>
<head>
<title>Ex. 4. PHP & SQL - for, foreach, while and do while.</title>
...
<div class="container">
    ...
    <h1 id="Nadpis_headline">PHP language - 4. For, foreach, while and do ... while </h1> <!-- Príklad vloženia nadpisu prvej úrovne -->
      ...
      <div class="articles ">
          ...
          <div class="form-group">
                  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST"> <!-- GET is changed to POST for this exercise. Can you say why?-->
                        <label for="room_temperature">Plese provide your room temperature in form XX.X </label><br />
